...
namespace KerbalWindTunnel.DataGenerators
{
    ...
    public class EnvelopeSurf
    {
        ...
        public readonly List<GraphDefinition> graphDefinitions = new List<GraphDefinition>
        {
            ...
            new SurfGraphDefinition("aoa_glide", p => p.AoA_gliding * Mathf.Rad2Deg) { DisplayName = "Glide AoA", ZUnit = "#autoLOC_KWT000", StringFormat = "F2", Enabled = WindTunnelSettings.EnableGlidingCalcs },
            new SurfGraphDefinition("fpa_glide", p => p.glideAngle * Mathf.Rad2Deg) { DisplayName = "Glide Angle", ZUnit = "#autoLOC_KWT000", StringFormat = "F2", Enabled = WindTunnelSettings.EnableGlidingCalcs }
            //new SurfGraphDefinition("ldRatio_glide", p => p.LDRatioGliding) { DisplayName = "Glide Ratio", ZUnit = "#autoLOC_KWT015", StringFormat = "F2", Enabled = WindTunnelSettings.EnableGlidingCalcs }
        };
        ...
        public readonly OutlineGraphDefinition<EnvelopePoint> envelope_glide = new OutlineGraphDefinition<EnvelopePoint>("envelope_glide", p => p.glideResidual) { DisplayName = "Glide Envelope", ZUnit = "#autoLOC_KWT004", StringFormat = "N0", Color = Color.white, LineWidth = 2, LineOnly = true, MaskCriteria = (v) => !float.IsNaN(v.z) && !float.IsInfinity(v.z) ? v.z : -1, Enabled = WindTunnelSettings.EnableGlidingCalcs };
        ...
        public EnvelopeSurf()
        {
            ...
            graphDefinitions.Add(envelope_glide);
