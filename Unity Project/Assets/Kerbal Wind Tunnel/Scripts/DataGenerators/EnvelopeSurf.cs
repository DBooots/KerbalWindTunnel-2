...
namespace KerbalWindTunnel.DataGenerators
{
    ...
    public class EnvelopeSurf
    {
        ...
        public readonly OutlineGraphDefinition<EnvelopePoint> envelope_glide = new OutlineGraphDefinition<EnvelopePoint>("envelope_glide", p => p.glideResidual) { DisplayName = "#autoLOC_KWT357", ZUnit = "#autoLOC_KWT004", StringFormat = "N0", Color = Color.white, LineWidth = 2, LineOnly = true, MaskCriteria = (v) => !float.IsNaN(v.z) && !float.IsInfinity(v.z) ? v.z : -1, Enabled = WindTunnelSettings.EnableGlidingCalcs };   // "Glide Envelope" "kN"
